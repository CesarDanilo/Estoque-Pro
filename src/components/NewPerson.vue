      ...
      <form class="space-y-4" @submit.prevent="salvar">
        <div class="grid gap-4 md:grid-cols-2">
          <div class="md:col-span-2">
            <label for="nome" class="mb-1 block text-sm font-medium">
          ...
          <div>
            <label for="genero" class="mb-1 block text-sm font-medium">Gênero</label>
          ...
          <div>
            <label for="nascimento" class="mb-1 block text-sm font-medium">Data de nascimento</label>
            <Input id="nascimento" v-model="form.nascimento" type="date" class="h-10 cursor-text" />
          </div>
        </div>
        ...
        <div class="grid gap-4 md:grid-cols-3">
          <div>
            <label for="cep" class="mb-1 block text-sm font-medium">CEP</label>
            <input
              id="cep"
          ...
          <div>
            <label for="cidade" class="mb-1 block text-sm font-medium">Cidade</label>
            <Input id="cidade" v-model="form.cidade" placeholder="Campo Grande" :maxlength="80" class="h-10 cursor-text" />
          </div>
          <div>
            <label for="endereco" class="mb-1 block text-sm font-medium">Endereço</label>
