...
const estilos = {
  success: 'border-emerald-500/40 bg-emerald-500/10 text-emerald-700 [&>svg]:text-emerald-600 dark:text-emerald-400',
  info: 'border-border',
...
<template>
  <Teleport to="body">
    <div class="pointer-events-none fixed right-4 top-4 z-50 w-[calc(100%-2rem)] max-w-sm md:right-6 md:top-6">
      <Transition
      ...
      >
        <Alert
          v-if="feedback"
          :class="['pointer-events-auto relative bg-background pr-10 shadow-lg', estilos[feedback.tipo]]"
        >
